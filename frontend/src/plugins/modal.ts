...
export default {
  ...
  // 弹出提示
  alert(content: any) {
    ElMessageBox.alert(content, '系统提示', { confirmButtonText: '确定' });
  },
  // 错误提示
  alertError(content: any) {
    ElMessageBox.alert(content, '系统提示', { confirmButtonText: '确定', type: 'error' });
  },
  // 成功提示
  alertSuccess(content: any) {
    ElMessageBox.alert(content, '系统提示', { confirmButtonText: '确定', type: 'success' });
  },
  // 警告提示
  alertWarning(content: any) {
    ElMessageBox.alert(content, '系统提示', { confirmButtonText: '确定', type: 'warning' });
  },
  // 通知提示
  notify(content: any) {
