-- Move the lively sky-blue default to the cleaner blue-white government-style default.
-- This targets only the previous shipped lively default, leaving customized
...
where config_key = 'crehn.workbench.style'
  ...
  and config_value like '%#e9f8ff%'
  and config_value like '%#0ea5e9%'
  and config_value like '%"sBg":"#f0f9ff"%';
