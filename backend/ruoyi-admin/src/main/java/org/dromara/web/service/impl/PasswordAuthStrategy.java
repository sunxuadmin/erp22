...
public class PasswordAuthStrategy implements IAuthStrategy {
    ...
    public LoginVo login(String body, SysClientVo client) {
        ...
        // 验证码开关
        if (captchaEnabled) {
            String captchaUsername = TenantHelper.dynamic(tenantId, () -> resolveCanonicalUsername(username));
            validateCaptcha(tenantId, captchaUsername, code, uuid);
        }
    ...
    private String resolveCanonicalUsername(String username) {
        SysUserVo user = findUserByUsernameOrAlias(username);
        return ObjectUtil.isNull(user) ? username : user.getUserName();
    }
    ...
    private SysUserVo findUserByUsernameOrAlias(String username) {
