...
public class SysUserController extends BaseController {
    ...
    public R<UserInfoVo> getInfo() {
        ...
        boolean closeWarningEnabled = roleService.selectRolesByUserId(loginUser.getUserId()).stream()
            .filter(role -> SystemConstants.NORMAL.equals(role.getStatus()))
            .anyMatch(role -> Boolean.TRUE.equals(role.getCloseWarningEnabled()));
        userInfoVo.setCloseWarningEnabled(closeWarningEnabled);
    ...
    @Log(title = "用户管理", businessType = BusinessType.UPDATE)
    @RepeatSubmit()
    @PutMapping("/unlockLogin/{userName}")
    public R<Void> unlockLogin(@PathVariable String userName) {
