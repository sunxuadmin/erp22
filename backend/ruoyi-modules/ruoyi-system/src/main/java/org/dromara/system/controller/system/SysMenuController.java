...
public class SysMenuController extends BaseController {
    ...
    public R<MenuTreeSelectVo> roleMenuTreeselect(@PathVariable("roleId") Long roleId) {
        ...
        SysRoleVo scopeRole = roleService.selectPermissionScopeRole(roleId);
        if (scopeRole != null) {
            Set<Long> allowedMenuIds = new HashSet<>(roleService.selectRoleMenuIds(scopeRole.getRoleId()));
            menus.removeIf(menu -> !allowedMenuIds.contains(menu.getMenuId()));
            checkedKeys.removeIf(menuId -> !allowedMenuIds.contains(menuId));
        }
        MenuTreeSelectVo selectVo = new MenuTreeSelectVo(
            checkedKeys,
            menuService.buildMenuTreeSelect(menus),
            scopeRole == null ? null : scopeRole.getRoleId(),
            scopeRole == null ? null : scopeRole.getRoleName(),
            scopeRole == null ? null : scopeRole.getRoleKey());
    ...
    public R<MenuTreeSelectVo> tenantPackageMenuTreeselect(@PathVariable("packageId") Long packageId) {
        ...
        MenuTreeSelectVo selectVo = new MenuTreeSelectVo(ids, list, null, null, null);
        return R.ok(selectVo);
    }
     ...
     * @param permissionScopeRoleId 菜单权限上限角色ID
     * @param permissionScopeRoleName 菜单权限上限角色名称
     * @param permissionScopeRoleKey 菜单权限上限角色标识
     */
    public record MenuTreeSelectVo(List<Long> checkedKeys, List<Tree<Long>> menus,
                                   Long permissionScopeRoleId, String permissionScopeRoleName,
                                   String permissionScopeRoleKey) {
    }
