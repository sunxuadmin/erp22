...
public interface ISysOssService {
    ...
    SysOssDirectUploadVo createDirectUpload(String originalName, Duration expiresIn);

    SysOssVo registerDirectUpload(String originalName, String objectKey, String contentType, Long fileSize);

    Long getObjectSize(String objectKey);

    Path downloadToTemp(String objectKey);
