...
public interface ISysRoleService {
     ...
     *
     * @param roleId 角色ID
     * @return 权限上限角色；未配置时返回 null
     */
    SysRoleVo selectPermissionScopeRole(Long roleId);

    /**
     * 查询以指定角色为菜单权限上限的子角色ID。
     *
     * @param roleId 上限角色ID
     * @return 子角色ID列表
     */
    List<Long> selectPermissionScopeChildRoleIds(Long roleId);
     ...
     * @return 结果
     */
    int updateRoleCloseWarning(Long roleId, Boolean closeWarningEnabled);
